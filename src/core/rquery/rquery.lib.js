...
class RQuery {
	...
	*/
	 ...
	 * @param {function(Event): void} callback - This event listener function to execute when the selected element is clicked. The function will receive the event object as its argument
	 * @returns {RQuery} The current RQuery instance for chaining
	*/
	click(callback) {
	...
	*/
	...
	/** 
	 * Set or get the value of on attribute on the selected element.
	 * @param {string} attributeName - The name of the attribute to set or get.
	 * @param {string} [value] - The value to set for the attribute. If not provided, the current value of the attribute will be returnde.
